$(document).ready(function () {
    ...
    var jokes = [
        ...
        "You've got limited edition slow fingers! go claim your Guinness record!",
    ];
    ...
    function reset(){
        ...
        $('.result-hide').addClass('.hide').html('');
        $('.bird').css({
            'top': '50%',
            'left': 0
        });
    ...
    $(window).keyup(function (e) {
        position = $('.bird').offset();
        // console.log('position ', position);
      });
    
      function showResult(msg, className) {
        $('.result-hide').removeClass('.hide').html(`
